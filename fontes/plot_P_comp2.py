...
for i in range(1,pnum+1):
    ...
    xx3, yy3, P3 = np.loadtxt(inDataNameP,unpack=True,usecols=[2,3,4])
    #print xx
    #print yy
    #print P
    #fig = plt.figure()
...
ax.plot(dt2,Jprod2,label=u'Produção')
ax.plot(dt3,Jprod3,'x',label=u'Produção')
box = ax.get_position()
...
ax.plot(dt2,Flux2,label=u'Fluxo Mássico')
ax.plot(dt3,Flux3,label=u'Fluxo Mássico')
box = ax.get_position()
