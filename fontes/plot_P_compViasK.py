...
for i in range(1,pnum+1):
    ...
    #ax.plot(xx4,P4,'-.',label=r'Desacoplado $(k=cte)$')
    ax.plot(xx5,P5,'-.',label=r'Uma-via $(k=cte)$',linewidth=2.0)
    ax.plot(xx6,P6,'-.',label=r'Duas-vias $(k=cte)$',linewidth=2.0)
...
plt.savefig('./' + filepath + 'tmpPressaoC_compK.pdf')
#plt.show()
...
plt.savefig('./' + filepath + 'tmpPressaoBC_compK.pdf')
#plt.show()
'''
...
for i in range(1,pnum+1):
    ...
    #plt.pcolor(xx,yy,P)
    #ax.contour(xx, yy, P)
    #plt.savefig('./teste/tmpPressao%dK.pdf' % i_mask)
...
#ax.legend()
plt.grid(True)
plt.savefig('./' + filepath + 'tmpgradPressao_compK.pdf')
#plt.show()
...
#ax.legend()
plt.grid(True)
plt.savefig('./' + filepath + 'tmpV_compK.pdf')
#plt.show()
...
#ax.legend()
plt.grid(True)
plt.savefig('./' + filepath + 'tmpJ_compK.pdf')
#plt.show()
...
#ax.legend()
plt.grid(True)
plt.savefig('./' + filepath + 'tmpResid_compK.pdf')
#plt.show()
'''
## Produção do bloco
fig = plt.figure()
...
#ax.plot(dt4,Jprod4,'-.',label=r'Desacoplado $(k=cte)$')
ax.plot(dt5,Jprod5,'-.',label=r'Uma-via $(k=cte)$',linewidth=2.0)
ax.plot(dt6,Jprod6,'-.',label=r'Duas-vias $(k=cte)$',linewidth=2.0)
box = ax.get_position()
ax.set_position([0.1*box.x0+box.x0, box.y0, box.width * 0.8, box.height])
#ax.legend(loc='center left', bbox_to_anchor=(1, 0.5))
ax.legend(loc='best')
plt.grid(True)
plt.savefig('./' + filepath + 'Prod_compK.pdf')
#plt.show()
'''
# RF barra
fig = plt.figure()
...
ax.legend(loc='center left', bbox_to_anchor=(1, 0.5))
plt.grid(True)
plt.savefig('./' + filepath + 'RF_compK.pdf')
#plt.show()
...
ax.legend(loc='center left', bbox_to_anchor=(1, 0.5))
plt.grid(True)
plt.savefig('./' + filepath + 'RFcompK.pdf')
#plt.show()
'''
fig = plt.figure()
#ax = fig.gca(projection='3d')
...
#ax.plot(dt4,Flux4,'-.',label=r'Desacoplado $(k=cte)$')
ax.plot(dt5,Flux5,'-.',label=r'Uma-via $(k=cte)$',linewidth=2.0)
ax.plot(dt6,Flux6,'-.',label=r'Duas-vias $(k=cte)$',linewidth=2.0)
box = ax.get_position()
ax.set_position([0.45*box.x0+box.x0, box.y0, box.width * 0.95, box.height])
#ax.legend(loc='center left', bbox_to_anchor=(1, 0.5))
ax.legend(loc='best')
plt.grid(True)
plt.savefig('./' + filepath + 'FluxoK.pdf')
#plt.show()
